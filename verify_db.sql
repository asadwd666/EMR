...
(1, 'Asad_Ali_CV.pdf', '', 'Asad Ali.pdf', 'feff', 34, 'unverified');
...
(1, 'Diabetes', 'Father', 34, 'ghsdvchgfd', 'unverified');
...
INSERT INTO `medical_record` (`id`, `patient_id`, `diabetic`, `diabetic_diagnosis_date`, `high_blood_presuure`, `HBP_diagnosis_date`, `cancer`, `cancer_diagnosis_date`, `cancer_type`, `treat_recieved_date`, `heart_attack`, `heart_diagnosis_date`, `HIV_hepatitis_etc`, `blood_transfusion`, `transfusion_date`, `blood_group`, `mental_health_condition`, `specify_mental`, `stroke`, `stroke_diagnosis_date`, `immune_disorder`, `immune_diagnosis_date`, `lung_disease`, `specify_lung_disease`, `lung_disease_diagnosis`, `ulcerative_crohn_etc`, `specify_ulcerative_etc`, `diagnosis_ulcerative_etc`, `neurogical_disease`, `specify_neurogical_disease`, `neuragical_diagnosis`, `BP_disorder`, `specify_bp_disorder`, `bp_diagnosis_date`, `cardiac_pacemaker`, `date_of_pacemaker`, `type_pacemaker`, `other_med_con`, `diagnosis_date_other`, `additional_note`, `status`, `New`) VALUES
(5, 34, 'no', '0000-00-00', ' no', '0000-00-00', ' yes', '2022-05-23', ' ', '2022-05-24', 'yes', '0000-00-00', ' yes', 'yes', '0000-00-00', '', ' yes', '', 'yes', '0000-00-00', 'yes', '0000-00-00', 'yes', '', '0000-00-00', 'yes', '', '0000-00-00', 'yes', '', '0000-00-00', ' yes', '', '0000-00-00', 'yes', '0000-00-00', '', '', '0000-00-00', '', 'verified', 'i have no mental health condition'),
(6, 34, 'no', '0000-00-00', ' no', '0000-00-00', ' no', '0000-00-00', ' ', '0000-00-00', 'no', '0000-00-00', ' no', 'no', '0000-00-00', '', ' no', '', 'no', '0000-00-00', 'no', '0000-00-00', 'no', '', '0000-00-00', 'no', '', '0000-00-00', 'no', '', '0000-00-00', ' no', '', '0000-00-00', 'no', '0000-00-00', '', '', '0000-00-00', '', 'unverified', ''),
(7, 34, 'no', '0000-00-00', ' no', '0000-00-00', ' no', '0000-00-00', ' ', '0000-00-00', 'no', '0000-00-00', ' no', 'no', '0000-00-00', '', ' no', '', 'no', '0000-00-00', 'no', '0000-00-00', 'no', '', '0000-00-00', 'no', '', '0000-00-00', 'no', '', '0000-00-00', ' no', '', '0000-00-00', 'no', '0000-00-00', '', '', '0000-00-00', '', 'unverified', '');
...
(1, 34, 'ddd', 'drr', '', 'ff', '0000-00-00', 'unverified');
...
INSERT INTO `miscellaneous` (`id`, `Document`, `Additional_Notes`, `patient_id`, `status`) VALUES
(1, 'Asad_Ali_CV.pdf', 'hjdhsjhjddjhsdsjhdsjh', 34, 'unverified');
